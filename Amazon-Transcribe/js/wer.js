...
module.exports = {
  ...
  calculateError: function calculateError(
    filename,
    resultsTablePath,
    resultsCSVPath
  ) {
    console.log('Error was detected so results were not calculated')
    module.exports.addToResultsTable('-', '-', filename, resultsTablePath)
    module.exports.addToResultsCSV(filename, '-', '-', '-', '-', resultsCSVPath)
  }
}
